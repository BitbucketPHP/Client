...
class Issues extends AbstractWorkspacesApi
{
    ...
    {
        return new Attachments($this->getClient(), $this->workspace, $this->repo, $issue, $this->getPerPage());
    }
    ...
    {
        return new Changes($this->getClient(), $this->workspace, $this->repo, $issue, $this->getPerPage());
    }
    ...
    {
        return new Comments($this->getClient(), $this->workspace, $this->repo, $issue, $this->getPerPage());
    }
    ...
    {
        return new Voting($this->getClient(), $this->workspace, $this->repo, $issue, $this->getPerPage());
    }
    ...
    {
        return new Watching($this->getClient(), $this->workspace, $this->repo, $issue, $this->getPerPage());
    }
