...
class Commit extends AbstractUsersApi
{
    ...
    {
        return new CommitProperties($this->getHttpClient(), $this->username, $this->repo, $commit);
    }
    ...
    {
        return new CommitPullRequests($this->getHttpClient(), $this->username, $this->repo, $commit);
    }
